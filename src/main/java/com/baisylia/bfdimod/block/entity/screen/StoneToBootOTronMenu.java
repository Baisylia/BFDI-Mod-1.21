...
public class StoneToBootOTronMenu extends AbstractContainerMenu {

    private final StoneToBootOTronBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public StoneToBootOTronMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public StoneToBootOTronMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenus.STONE_TO_BOOT_O_TRON_MENU.get(), pContainerId);
        checkContainerSize(inv, 10);
        blockEntity = ((StoneToBootOTronBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.STONE_TO_BOOT_O_TRON.get());
    }
