package com.baisylia.bfdimod.block;

import com.baisylia.bfdimod.BFDIMod;
import com.baisylia.bfdimod.block.custom.*;
import com.baisylia.bfdimod.item.ModItems;
import com.baisylia.bfdimod.world.tree.ModTreeGrowers;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> STONE_TO_BOOT_O_TRON = registerBlock("stone_to_boot_o_tron",
            () -> new StoneToBootOTronBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BRICKS)));
